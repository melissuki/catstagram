...
export const translations = {
  en: {
    ...
    auth: {
      ...
      gateTitle: 'Join us!',
      gateBody:
        'Join us! Sign in or create an account in 5 seconds to like and interact.',
      continueExploring: 'Keep exploring',
      joinCta: 'Join / Sign in',
      slowDown: 'Easy there — try again in a moment.',
  ...
  tr: {
    ...
    auth: {
      ...
      networkError: 'Bağlantı sorunu. Ağını kontrol edip tekrar dene.',
      gateTitle: 'Aramıza Katılın!',
      gateBody:
        'Aramıza Katılın! Beğenmek ve etkileşime geçmek için 5 saniyede giriş yapın veya kayıt olun.',
      continueExploring: 'Keşfetmeye devam et',
      joinCta: 'Katıl / Giriş yap',
      slowDown: 'Yavaş ol — biraz sonra tekrar dene.',
